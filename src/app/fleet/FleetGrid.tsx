...
export function FleetGrid({ yachts }: FleetGridProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {yachts.map((yacht, i) => (
        <Reveal key={yacht.slug} delay={i * 200}>
          <article className="group bg-navy-800 rounded-2xl overflow-hidden border border-white/5 hover:border-gold-500/20 transition-all duration-500 flex flex-col">
            {/* Image placeholder */}
            <div
