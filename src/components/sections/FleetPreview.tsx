...
import { trackYachtClick, trackWhatsAppClick } from "@/lib/analytics";
  ...
  return (
    <Reveal delay={index * 150}>
      <article className="group bg-navy-800 rounded-xl overflow-hidden border border-white/5 hover:border-gold-500/20 transition-colors duration-500">
        ...
        <Link href={`/fleet/${yacht.slug}`} className="relative aspect-[4/3] bg-gradient-to-br from-gold-500/20 via-gold-400/10 to-navy-700 overflow-hidden block" onClick={() => trackYachtClick(yacht.slug, "fleet_preview")}>
          {!imageError ? (
            <Image
              src={yacht.heroImage}
        ...
        <div className="p-6">
          ...
          <div className="mt-6 flex items-end justify-between gap-4">
            ...
            <a
              ...
              onClick={() => trackWhatsAppClick("fleet_preview")}
            >
